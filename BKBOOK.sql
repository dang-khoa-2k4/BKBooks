CREATE TABLE `book` (
    ...
    `genre` varchar(19) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `member` (
    ...
    PRIMARY KEY (`ID`),
    CONSTRAINT `fk_member_user` FOREIGN KEY (`ID`) REFERENCES `user` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `cart` (
    ...
    `BookID` int NOT NULL,
    `Quantity` int NOT NULL,
    `Status` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'available',
    PRIMARY KEY (`MemberID`, `BookID`),
    KEY `BookID` (`BookID`),
    CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`MemberID`) REFERENCES `member` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`BookID`) REFERENCES `book` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `comment` (
    ...
    PRIMARY KEY (`MemberID`, `BookID`, `Time`),
    KEY `comment_ibfk_1` (`BookID`),
    CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`BookID`) REFERENCES `book` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`MemberID`) REFERENCES `member` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `order` (
    ...
    CONSTRAINT `order_ibfk_1` FOREIGN KEY (`MemberID`) REFERENCES `member` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `contain` (
    ...
    KEY `OrderID` (`OrderID`),
    CONSTRAINT `contain_ibfk_1` FOREIGN KEY (`BookID`) REFERENCES `book` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `contain_ibfk_2` FOREIGN KEY (`OrderID`) REFERENCES `order` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `modify` (
    ...
    PRIMARY KEY (`UserID`, `MemberID`, `Time`),
    KEY `MemberID` (`MemberID`),
    CONSTRAINT `modify_ibfk_1` FOREIGN KEY (`MemberID`) REFERENCES `member` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `modify_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `user` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
);
