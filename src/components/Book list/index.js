...
import image1 from "../../Assert/images/image 5.png"
import image2 from "../../Assert/images/image 5 (1).png"
import image3 from "../../Assert/images/image 5 (2).png"
import image4 from "../../Assert/images/image 5 (3).png"

import { Link } from 'react-router-dom';

const BookCard1 = ({img,title}) => {
    return(
...
const BookList = () => {
    return (
        ...
        <h2
            class="text-3xl font-semibold text-gray-900 sm:text-3xl dark:text-white text-center"
            style={{color:"#393280"}}
          >
            New Release Books
          </h2>
          <p class="text-gray-500 dark:text-gray-400 mt-5 text-center">
          1000+ books are published by different authors everyday. 
          </p>
        <div className='w-full flex justify-center'>
            <Link
                to="/listing"
                class="text-center my-5 text-sm font-semibold text-orange-500 sm:text-sm dark:text-white text-center"
            > 
                View all products
    ...
    <BookCard1 img={image1} title={"The Mind Connection"} />
    <BookCard1 img={image2} title={"The Road to Recognition"}/>
    <BookCard1 img={image3} title={"Battlefield of the mind"} />
    <BookCard1 img={image4} title={"The Road to Recognition"} />
